...
function EditHackathonWebsite() {
  ...
  const [errors, setErrors] = useState({ aboutHack: "", aboutPrize: "" });
  ...
  function handleTextChange(e, textRef, field) {
    ...
    if (!validateInput(field, value)) {
      setErrors((prev) => ({
        ...prev,
        [field]:
          "Input must start with a letter and cannot begin with spaces or special characters.",
      }));
    } else {
  ...
  return (
    <>
      <div className="text-2xl mb-3 flex justify-center font-bold">
        This is what your website will display!
      </div>
          ...
          <div className="flex w-full h-full">
            <div>
              ...
              >
                ...
                <div
                  className="about-hack w-[500px]"
                  style={{ marginTop: "20px" }}
                >
                  <div className="text-2xl font-medium mb-5 flex justify-center">
                    About Hackathon
                  </div>
                    ...
                    >
                      <div className="text-center">
                        ...
                        <div className="flex justify-end">
                          <button
                            className="remove-link-btn1 edit-btn mt-2 mr-0 ml-2 font-medium"
                ...
                <button
                  onClick={addField}
                  className="add-link-btn edit-btn py-2 px-3 mt-[20px] font-medium"
                >
                  Add more fields
                </button>
              </div>
              ...
              <div className="flex">
                <button
                  ...
                  className="edit-inp w-auto bg-[#5f3abd] hover:bg-[#5f3abd] text-white font-bold py-3 px-6 rounded focus:outline-none focus:shadow-outline edit-btn mt-4"
                >
                  Save Changes
                </button>
              </div>
            ...
            <div>
              <div
                className="hack-info-card flex flex-col justify-between w-[250px] h-28"
                style={{ marginLeft: "30px" }}
              >
                <div>From: To:</div>

                <div className="flex justify-center">
                  <button className="w-11/12 text-sm p-1 bg-gray-400 text-white rounded-md font-semibold cursor-default">
                    Apply
                  </button>
                </div>
              </div>
